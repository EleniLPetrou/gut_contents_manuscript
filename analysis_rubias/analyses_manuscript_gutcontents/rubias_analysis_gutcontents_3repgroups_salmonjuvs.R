...
output_mix_ests <- "./analysis_rubias/analyses_manuscript_gutcontents/results_rubias_analysis_gutcontents_3repgroups_juvenilesalmon_byseason.txt"
output_post_probs <- "./analysis_rubias/analyses_manuscript_gutcontents/results_rubias_3repgroups_juvenilesalmon_byseason_posteriorprob.txt"
...
# Add metadata to mixture dataframe and filter it such that only juvenile salmon are retained
...
mylabels <- c(spring = "spring (N= 47)", summer = "summer (N= 40)" )
